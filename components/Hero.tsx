      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <div className="text-justify md:tracking-wider mb-4 text-sm md:text-lg lg:text-xl max-w-4xl">
            ...
            <p className="mt-4">
              Throughout my journey as a developer, I have worked across multiple frontend frameworks including <span className="text-purple">React.js</span>, <span className="text-purple">React TypeScript</span>, <span className="text-purple">Next.js</span>, <span className="text-purple">Vue.js</span>, and <span className="text-purple">Angular</span>, consistently delivering high-quality solutions that meet client expectations. I also bring hands-on experience with backend technologies such as <span className="text-purple">Node.js</span>, <span className="text-purple">Laravel</span>, and <span className="text-purple">Spring Boot</span>, enabling me to contribute effectively across the full stack. My experience spans both independent work and collaborative team environments, highlighting my adaptability and strong communication skills.
            </p>
            <p className="mt-4">
